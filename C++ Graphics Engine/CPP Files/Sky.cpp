...
Sky::Sky(std::shared_ptr<Mesh> _mesh, Microsoft::WRL::ComPtr<ID3D11SamplerState> _samplerState, Microsoft::WRL::ComPtr<ID3D11PixelShader> _pixelShader,
	...
	const wchar_t* back)
{
	...
	Graphics::Device->CreateRasterizerState(&rastDesc, &rasterizerState);
...
void Sky::Draw()
{
	...
	// bind shaders
	Graphics::Context->VSSetShader(0, 0, 0);
	Graphics::Context->PSSetShader(0, 0, 0);

	// bind sampler and SRV
	Graphics::Context->PSSetSamplers(0, 0, 0);
	Graphics::Context->PSSetShaderResources(0, 0 , 0);
}
